...
type
  ...
  public
    ...
    var PipelineSolid: TLabPipelineShared;
...
begin
  ...
  Window.Ptr.Caption := 'Vulkan Geometry Shader';
  ...
  DescriptorSets := DescriptorSetsFactory.Ptr.Request([
    LabDescriptorSetBindings([
      LabDescriptorBinding(
        ...
        TVkFlags(VK_SHADER_STAGE_VERTEX_BIT) or TVkFlags(VK_SHADER_STAGE_GEOMETRY_BIT)
      )
    ])
  ]);
...
begin
  ...
  CmdBuffer.Ptr.BindPipeline(PipelineSolid.Ptr);
