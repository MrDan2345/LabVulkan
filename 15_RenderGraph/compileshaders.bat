...
REM "%VULKAN_SDK%/Bin32/glslangValidator.exe" -V -S frag -DMULTISAMPLED=0 -t light_ps.txt -o light_ps.spv
REM "%VULKAN_SDK%/Bin32/glslangValidator.exe" -V -S frag -DMULTISAMPLED=1 -t light_ps.txt -o light_ps_ms.spv
popd
pause
goto :eof
