...
type
  ...
  TLightData = class (TLabClass)
    ...
    type TUniformPixelShared = specialize TLabSharedRef<TUniformPixel>;
    ...
    var UniformBufferPixel: TUniformPixelShared;
...
begin
  u := App.SwapChain.Ptr.Width / App.WidthRT;
  v := App.SwapChain.Ptr.Height / App.HeightRT;
  UniformBuffer.Ptr.Buffer^.ScreenSize.x := App.SwapChain.Ptr.Width;
  UniformBuffer.Ptr.Buffer^.ScreenSize.y := App.SwapChain.Ptr.Height;
  UniformBuffer.Ptr.Buffer^.ScreenSize.z := 1 / App.SwapChain.Ptr.Width;
  UniformBuffer.Ptr.Buffer^.ScreenSize.w := 1 / App.SwapChain.Ptr.Height;
  QuadData[1].u := u;
  QuadData[2].v := v;
  QuadData[3].u := u;
  QuadData[3].v := v;
